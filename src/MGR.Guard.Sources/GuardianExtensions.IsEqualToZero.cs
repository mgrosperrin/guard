...
namespace MGR.Guard
{
        ...
        static partial class GuardianExtensions
    {
        ...
        [PublicAPI]
        public static void IsEqualToZero([NotNull] this Guardian source, [NotNull] Expression<Func<int>> expression)
        {
            ...
            IsEqualToZero(source, value, parameterName);
        }
        /// <summary>
        ///     Checks if the specified value is equal to zero.
        /// </summary>
        ...
        [PublicAPI]
        public static void IsEqualToZero([NotNull] this Guardian source, int value, [NotNull] string parameterName)
        {
            if (value != 0)
            {
        ...
        /// <param name="expression">The value as an Expression.</param>
        [PublicAPI]
        public static void IsEqualToZero([NotNull] this Guardian source, [NotNull] Expression<Func<long>> expression)
        {
            source.IsNotNull(expression, nameof(expression));
        ...
        /// <param name="expression">The value as an Expression.</param>
        [PublicAPI]
        public static void IsEqualToZero([NotNull] this Guardian source, [NotNull] Expression<Func<double>> expression)
        {
            source.IsNotNull(expression, nameof(expression));
        ...
        /// <param name="expression">The value as an Expression.</param>
        [PublicAPI]
        public static void IsEqualToZero([NotNull] this Guardian source, [NotNull] Expression<Func<float>> expression)
        {
            source.IsNotNull(expression, nameof(expression));
        ...
        /// <param name="parameterName">Name of the parameter.</param>
        [PublicAPI]
        public static void IsEqualToZero([NotNull] this Guardian source, float value, [NotNull] string parameterName)
        {
