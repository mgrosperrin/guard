...
namespace MGR.Guard
{
        ...
        static partial class GuardianExtensions
    {
        ...
        [PublicAPI]
        public static void IsGreaterThanOrEqualTo<T>([NotNull] this Guardian source, [NotNull] Expression<Func<T>> expression, T minLimit)
        {
            ...
            IsGreaterThanOrEqualTo(source, value, parameterName, minLimit);
        }
