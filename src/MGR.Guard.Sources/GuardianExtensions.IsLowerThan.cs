...
namespace MGR.Guard
{
        ...
        static partial class GuardianExtensions
    {
        ...
        [PublicAPI]
        public static void IsLowerThan<T>([NotNull] this Guardian source, [NotNull] Expression<Func<T>> expression, T maxLimit)
        {
            ...
            IsLowerThan(source, value, parameterName, maxLimit);
        }
        ...
        public static void IsLowerThan<T>([NotNull] this Guardian source, T value, [NotNull] string parameterName, T maxLimit)
        {
            ...
            if (stringValue != null)
            {
                IsLowerThan(source, stringValue, parameterName, maxLimit as string, StringComparer.CurrentCulture);
            }
            else
            {
                IsLowerThan(source, value, parameterName, maxLimit, Comparer<T>.Default);
            }
        }
        ...
        [PublicAPI]
        public static void IsLowerThan<T>([NotNull] this Guardian source, [NotNull] Expression<Func<T>> expression, T maxLimit, [NotNull] IComparer<T> comparer)
        {
            source.IsNotNull(expression, nameof(expression));
