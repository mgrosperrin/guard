...
namespace MGR.Guard
{
        ...
        static partial class GuardianExtensions
    {
        ...
        /// <param name="source">The <see cref="Guard"/> to extends.</param>
        ...
        /// <param name="maxLimit">The max limit.</param>
        [PublicAPI]
        public static void IsStrictlyBetween<T>([NotNull] this Guardian source, T value, [NotNull] string parameterName, T minLimit, T maxLimit)
        {
            var stringValue = value as string;
            if (stringValue != null)
            {
                IsStrictlyBetween(source, stringValue, parameterName, minLimit as string, maxLimit as string, StringComparer.CurrentCulture);
            }
            else
            {
                IsStrictlyBetween(source, value, parameterName, minLimit, maxLimit, Comparer<T>.Default);
            }
        }
        /// <summary>
        ///     Checks if the specified value is strictly between the minLimit and the maxLimit.
        ...
        /// <param name="comparer">The comparer.</param>
        [PublicAPI]
        public static void IsStrictlyBetween<T>([NotNull] this Guardian source, T value, [NotNull] string parameterName, T minLimit, T maxLimit, [NotNull] IComparer<T> comparer)
        {
            if (comparer == null)
            {
