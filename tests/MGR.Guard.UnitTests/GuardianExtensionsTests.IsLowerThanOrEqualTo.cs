    ...
    public partial class GuardianExtensionsTests
    {
        public class IsLowerThanOrEqualTo
        {
            ...
            public void String_Value_Is_Not_Lower_Than_Or_Equals_To_AAA()
            {
                ...
                // Act & Assert
                var actualException = Assert.Throws<ArgumentOutOfRangeException>(() => Guardian.ChecksThat.IsLowerThanOrEqualTo(test, "test", maxLimit));
            ...
            public void String_Value_Is_Lower_Than_Or_Equals_To_ZZZ()
            {
                ...
                // Act
                Guardian.ChecksThat.IsLowerThanOrEqualTo(test, "test", maxLimit);
                // Assert
                Assert.True(true);
            }
